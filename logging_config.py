...
def setup_logging():
	...
	# Setup single handler for all loggers with UTF-8 encoding
	# Create a stream that explicitly uses UTF-8
	if sys.platform == 'win32':
		import io
		# Create a UTF-8 text wrapper around the binary buffer
